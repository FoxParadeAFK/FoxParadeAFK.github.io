  ...
  return (
    <>
      ...
      <div style = {{display: 'flex', flexWrap: 'wrap'}}> 
        <Card 
          image = {{ path: "src/assets/comps/_images/Logo_Godot.png", alt: "Godot" }} 
          description = "Godot  ∙  Game Engine"/>
        <Card 
          image = {{ path: "src/assets/comps/_images/Logo_Aseprite.png", alt: "Aseprite" }} 
          description = "Aseprite  ∙  2D Pixel Art"/>
        <Card 
          image = {{ path: "src/assets/comps/_images/Logo_VS.png", alt: "VScode" }} 
          description = "VScode  ∙  Code Editor"/>
        <Card 
          image = {{ path: "src/assets/comps/_images/Logo_Git.png", alt: "Git" }} 
          description = "Git  ∙  Version Control"/>
        <Card 
          image = {{ path: "src/assets/comps/_images/Logo_Linux.png", alt: "Linux" }} 
          description = "Linux  ∙  Unbuntu"/>
        <Card 
          image = {{ path: "src/assets/comps/_images/Logo_Notebook.png", alt: "Jupyter Notebooks" }} 
